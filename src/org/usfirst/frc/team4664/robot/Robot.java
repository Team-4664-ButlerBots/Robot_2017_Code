...
public class Robot extends SampleRobot implements Constants{
	//drive system declaration
	RobotDrive driveSystem;
	
	//various motor declaration
	Victor collectMotor;
	Victor shootMotor;
	Victor hopperMotor;
	Victor climbMotor;
	...
	public void operatorControl() {
		...
		while (isOperatorControl() && isEnabled()) {
			...
			while(!returnedValue)
				returnedValue = AgitatorControl();
			
			//Collector Control
			while(!returnedValue)
				returnedValue = CollectorControl();
	 ...
	 * 
	 */
	private boolean AgitatorControl(){
	...
	private boolean CollectorControl(){
		//COLLECTOR CONTROL
